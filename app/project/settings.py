...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "mol"),
        "USER": os.environ.get("DB_USER", "mol"),
        "PASSWORD": os.environ.get("DB_PASSWORD", "mol"),
        "HOST": os.environ.get("DB_HOST", "192.168.100.10"),
        "PORT": os.environ.get("DB_PORT", "5432"),
        "OPTIONS": {"options": "-c search_path=django,public", "application_name": "molmash_django"},
    }
}
...
AUTH_USER_MODEL = "mol.Account"
AUTH_PASSWORD_VALIDATORS = [
    {"NAME": "mol.validators.PasswordValidator"},
]
